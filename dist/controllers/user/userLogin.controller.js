...
var userLogin_service_1 = __importDefault(require("../../services/user/userLogin.service"));
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, userLogin_service_1["default"])({ email: email, password: password })];
            case 1:
                response = _b.sent();
