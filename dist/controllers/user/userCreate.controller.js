...
var userCreate_service_1 = __importDefault(require("../../services/user/userCreate.service"));
var userCreateController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, password, phone, response, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, name = _a.name, email = _a.email, password = _a.password, phone = _a.phone;
                return [4 /*yield*/, (0, userCreate_service_1["default"])({
                        name: name,
                        email: email,
                        password: password,
                        phone: phone
