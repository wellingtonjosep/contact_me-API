...
var userUpdateService = function (_a) {
    var id = _a.id, name = _a.name, email = _a.email, password = _a.password, phone = _a.phone;
    return __awaiter(void 0, void 0, void 0, function () {
        var user, newUser, userUpdate;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    userUpdate = _b.sent();
                    return [2 /*return*/, __assign(__assign({}, userUpdate), { password: undefined })];
            }
        });
    });
};
